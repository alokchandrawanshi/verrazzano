...
import (
	...
	components "github.com/verrazzano/verrazzano/platform-operator/controllers/configmaps/apidev"
	platformapi "github.com/verrazzano/verrazzano/platform-operator/controllers/platformctrl/types/verrazzano/v1beta2"
...
var _ components.ConfigMapDelegateReconciler = &VerrazzanoModuleReconciler{}
...
func (r *VerrazzanoModuleReconciler) FinalizerName() string {
	return finalizerName
}

func (r *VerrazzanoModuleReconciler) Matches(group string, version string, kind string) bool {
	groupVersion := platformapi.SchemeBuilder.GroupVersion
...
func (r *VerrazzanoModuleReconciler) DoReconcile(log vzlog.VerrazzanoLogger, object interface{}) (ctrl.Result, error) {
	moduleInstance := object.(*platformapi.Module)
	result, err := r.doReconcile(log, moduleInstance)
	if err != nil {
		return result, err
	}
...
func (r *VerrazzanoModuleReconciler) DoDelete(log vzlog.VerrazzanoLogger, object interface{}) (ctrl.Result, error) {
	moduleInstance := object.(*platformapi.Module)
	log.Progressf("Deleting object %s/%s", moduleInstance.Namespace, moduleInstance.Name)
	return ctrl.Result{}, nil
}

func (r *VerrazzanoModuleReconciler) NewObject() interface{} {
	return &platformapi.Module{}
}

func NewConfigMapReconcilerDelegate(cli client.Client) components.ConfigMapDelegateReconciler {
	return &VerrazzanoModuleReconciler{
		Client: cli,
	}
}
...
// Name of finalizer
const (
	finalizerName = "vzmodule.verrazzano.io/finalizer"
...
func (r *VerrazzanoModuleReconciler) doReconcile(log vzlog.VerrazzanoLogger, moduleInstance *platformapi.Module) (ctrl.Result, error) {
	...
	//if _, err := r.reconcileModule(log, moduleInstance, chartName, targetModuleVersion, namespace, sourceURI); err != nil {
	//	return newRequeueWithDelay(), err
	//}
...
func (r *VerrazzanoModuleReconciler) reconcileModule(log vzlog.VerrazzanoLogger, moduleInstance *platformapi.Module, chartName string, moduleVersion string, namespace string, sourceURI string) (*v1.ConfigMap, error) {
	lifecycleResource, err := r.createLifecycleResource(sourceURI, chartName, namespace, moduleVersion,
		vzapi.InstallOverrides{}, nil) //createOwnerRef(moduleInstance))
	if err != nil {
		return nil, err
	}
...
func (r *VerrazzanoModuleReconciler) createLifecycleResource(sourceURI string, chartName string, chartNamespace string, chartVersion string, overrides vzapi.InstallOverrides, ownerRef *metav1.OwnerReference) (*v1.ConfigMap, error) {

	// Create a CR to manage the module installation
	moduleInstaller := &v1.ConfigMap{}
	//&modulesv1alpha1.Module{
	//	ObjectMeta: metav1.ObjectMeta{
	//		Name:      chartName,
...
//func (r *VerrazzanoModuleReconciler) updateModuleInstanceState(instance *platformapi.Module, lifecycleResource *v1.ConfigMap) error {
