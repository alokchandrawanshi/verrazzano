...
const (
	...
	// Opster resources
	opsterAdminCertificateName                             = "opster-admin-cert"
	opsterNodeCertificateName                              = "opster-node-cert"
	opsterClientCertificateName                            = "opster-client-cert"
	...
	opsterCertCommonName                                   = "admin"
)

var opsterAdminDNSNames = []string{"admin"}
...
//func createOpsterAdminCertificate() certv1.Certificate {
//	//cli := compContext.Client()
//
...
//		},
//		ObjectMeta: metav1.ObjectMeta{
//			Name:      opsterAdminCertificateName,
//			Namespace: "default",
//		},
//		Spec: certv1.CertificateSpec{
//			Subject:    &certSubject,
//			CommonName: "admin", //decalare variable
//			Duration: &metav1.Duration{
//				time.Duration(2160) * time.Hour,
//			},
//			RenewBefore: &metav1.Duration{
//				time.Duration(360) * time.Hour,
//			},
...
//func createOpsterNodeCertificate() certv1.Certificate {
//	certSubject := certv1.X509Subject{
//		Organizations: []string{"verrazzano"},
//	}
//	cert := certv1.Certificate{
...
//		},
//		ObjectMeta: metav1.ObjectMeta{
//			Name:      opsterNodeCertificateName,
//			Namespace: "default",
//		},
//		Spec: certv1.CertificateSpec{
//			Subject:    &certSubject,
...
//			},
//			DNSNames:       opsterAdminDnsNames,
//			SecretName:     opsterNodeCertificateName,
//			SecretTemplate: nil,
//			IssuerRef: certmetav1.ObjectReference{
//				Name:  verrazzanoClusterIssuerName,
//				Kind:  "ClusterIssuer",
...
//func createOpsterClientCertificate() certv1.Certificate {
//	certSubject := certv1.X509Subject{
//		Organizations: []string{"verrazzano"},
//	}
//	cert := certv1.Certificate{
...
//		},
//		ObjectMeta: metav1.ObjectMeta{
//			Name:      opsterClientCertificateName,
//			Namespace: "default",
//		},
//		Spec: certv1.CertificateSpec{
//			Subject:    &certSubject,
...
// createOpsterClientCertificate Update the status field for each certificate generated by the Verrazzano ClusterIssuer
func getCertificateSpec() certv1.CertificateSpec {
	certSubject := certv1.X509Subject{
		Organizations: []string{"verrazzano"},
	}
...
func createOrUpdateCertResources(compContext spi.ComponentContext) (controllerutil.OperationResult, error) {
	// Create the certificate resource for CA cert
	var opResult controllerutil.OperationResult
	var issuerUpdateErr error
	compContext.Log().Debug("Applying Certificate for CA cert")
	adminCertObject := certv1.Certificate{
		TypeMeta: metav1.TypeMeta{
			Kind:       "Certificate",
			APIVersion: "cert-manager.io/v1",
		},
	...
	if opResult, issuerUpdateErr = controllerutil.CreateOrUpdate(context.TODO(), compContext.Client(), &adminCertObject, func() error {
		adminCertObject.Spec = getCertificateSpec()
		return nil
	}); issuerUpdateErr != nil {
		return controllerutil.OperationResultNone, compContext.Log().ErrorfNewErr("Failed to create or update the Certificate: %v", issuerUpdateErr)
	}
	return opResult, issuerUpdateErr
}
